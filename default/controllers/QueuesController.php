...
class QueuesController extends Zend_Controller_Action {
    ...
    public function indexAction() {
        ...
        $this->view->breadcrumb = $this->view->translate("Cadastro » Filas de Atendimento");

        $db = Zend_Registry::get('db');
        $select = $db->select()
                        ->from("queues", array("name", "strategy", "maxlen", "musiconhold"));
        ...
        $this->view->filter = array(array("url" => "/snep/src/queues.php",
                "display" => $this->view->translate("Incluir Fila de Atendimento"),
                "css" => "include"),
        );
    }

...
class ContactGroupsController extends Zend_Controller_Action {
    ...
    public function addAction() {
        ...
        $form = new Snep_Form( new Zend_Config_Xml("modules/default/formscontact_groups.xml") );
        $db = Zend_Registry::get('db');
    ...
    public function migrationAction() {
        ...
        Zend_Registry::set('cancel_url', $this->getFrontController()->getBaseUrl() . '/' . $this->getRequest()->getControllerName() . '/index');
        $form = new Snep_Form( new Zend_Config_Xml("modules/default/formscontact_groups_migration.xml") );

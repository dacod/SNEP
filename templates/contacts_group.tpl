...
<table cellspacing="0" align="center" class="contorno">
    ...
    <tr>
        ...
        <td class="noleftrightcenter" style="border-bottom:0px;text-align:center; vertical-align: middle;">
    ...
    <tr>
     <td colspan="3" class="subtable" align="center" height="38px" valign="middle">
        <input class="button" type="submit" id="gravar" value="{$LANG.save}">
        <div class="buttonEnding"></div>
        &nbsp;&nbsp;&nbsp;
        <input class="button" type="button" id="voltar" value="{$LANG.back}" onClick="location.href='../src/rel_ccustos.php'" />
        <div class="buttonEnding"></div>
     </td>

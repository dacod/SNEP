{* Smarty *}
{* ---------------------------------------------------------------------------- 
 * Template: queues_agent.tpl - Template da rotina queues-agent.php
 ...
 * ---------------------------------------------------------------------------- *}   
 ...
 <fieldset>
 <table align="center">
    <form name="formulario"  method="POST" enctype="multipart/form-data" action="{$smarty.server.SCRIPT_NAME}?acao={$ACAO}" onsubmit="check_form()" >
    <tr>
       ...
       <td class="subtable" style="text-align:center; vertical-align: middle;">
          <a href="#" onclick="movimento('lista2', 'cima')">
             <img src="../imagens/go-up.png" border="0"  /> 
          </a>
       </td>
    </tr>
    <tr>
       ...
       <td class="subtable" style="text-align:center; vertical-align: middle;">
          <a href="#" onclick="movimento('lista2', 'baixo')">
             <img src="../imagens/go-down.png"  border="0" />
          </a>
       </td>
    </tr>
    ...
    <tr>       
       <td colspan="4" class="cen" height="40px" valign="middle">
          ...
          &nbsp;&nbsp;&nbsp;
          <input class="button" type="button" name="voltar" value="{$LANG.back}" onClick="location.href='../gestao/agentes.php'" />
          <div class="buttonEnding"></div>      
       </td>
    </tr>
    </form>
